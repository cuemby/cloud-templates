...
echo "Starting CentOS CloudStack template preparation..."
...
history -c
> /root/.bash_history
> /home/centos/.bash_history 2>/dev/null || true

echo "CentOS CloudStack template preparation completed successfully!"