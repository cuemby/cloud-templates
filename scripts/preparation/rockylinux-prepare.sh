...
echo "Starting RockyLinux CloudStack template preparation..."
...
history -c
> /root/.bash_history
> /home/rocky/.bash_history 2>/dev/null || true

echo "RockyLinux CloudStack template preparation completed successfully!"